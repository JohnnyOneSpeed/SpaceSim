    ...
    public partial class App : Application
    {
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            if (SpaceSim.MainWindow.ProfilePaths.Count == 0)
            {
                SpaceSim.MainWindow.ProfilePaths = new List<string>
                {
                    //flightProfileManager.BuildFullPath("Apollo8"),
                    //flightProfileManager.BuildFullPath("AutoLanding Test"),
                    //flightProfileManager.BuildFullPath("AMOS-17"),
                    ...
                    //flightProfileManager.BuildFullPath("Dragon XL"),
                    //flightProfileManager.BuildFullPath("Electron"),
                    //flightProfileManager.BuildFullPath("ElectronRecovery"),
                    ...
                    //flightProfileManager.BuildFullPath("FH-PPE-HALO"),
                    //flightProfileManager.BuildFullPath("FH-STP-2"),
                    ...
                    //flightProfileManager.BuildFullPath("IFA2"),
                    ...
                    //flightProfileManager.BuildFullPath("SaturnV"),
                    ...
                    //flightProfileManager.BuildFullPath("Starlink-1.0"),
                    //flightProfileManager.BuildFullPath("StarshipASDS"),
                    //flightProfileManager.BuildFullPath("StarshipMk1"),
                    //flightProfileManager.BuildFullPath("StarshipSN4"),
                    //flightProfileManager.BuildFullPath("StarshipSN8"),
                    //flightProfileManager.BuildFullPath("StarshipSN8KM15"),
                    flightProfileManager.BuildFullPath("StarshipSN8KM125")
                    //flightProfileManager.BuildFullPath("StarshipP2P"),
                    //flightProfileManager.BuildFullPath("Starship2P2P"),
                    //flightProfileManager.BuildFullPath("StarshipTLI"),
                    //flightProfileManager.BuildFullPath("StarshipTMI"),
                    //flightProfileManager.BuildFullPath("StarHopper"),
                    //flightProfileManager.BuildFullPath("StarHopper150"),
                    //flightProfileManager.BuildFullPath("StarHopper200"),
                    //flightProfileManager.BuildFullPath("StarHopper03"),
                    //flightProfileManager.BuildFullPath("StarHopper04"),
                    //flightProfileManager.BuildFullPath("StarKicker"),
                    //flightProfileManager.BuildFullPath("StarshipSuperHeavyASDS"),
                    //flightProfileManager.BuildFullPath("Starship3SuperHeavy7RTLS"),
                    //flightProfileManager.BuildFullPath("Starship3SuperHeavy13ASDS"),
                    //flightProfileManager.BuildFullPath("Starship3SuperHeavy19RTLS"),
                    //flightProfileManager.BuildFullPath("StarshipSuperHeavy25RTLS"),
                    //flightProfileManager.BuildFullPath("StarshipSuperHeavy28RTLS"),
                    //flightProfileManager.BuildFullPath("StarshipSuperHeavy31RTLS"),
                    //flightProfileManager.BuildFullPath("StarshipSuperHeavy37RTLS"),
                    //flightProfileManager.BuildFullPath("StarshipSuperHeavy360RTLS"),
                    //flightProfileManager.BuildFullPath("StarshipSuperHeavy430RTLS"),
                    //flightProfileManager.BuildFullPath("StarshipSuperHeavyFTASDS"),
                    //flightProfileManager.BuildFullPath("Starship105RTLS"),
                    //flightProfileManager.BuildFullPath("StarshipDearMoonASDS"),
                    //flightProfileManager.BuildFullPath("StarshipDearMoonRTLS"),
                    //flightProfileManager.BuildFullPath("SaturnV"),
                    //flightProfileManager.BuildFullPath("StarshipSuperHeavyMk1"),
