...
{
    class SSGridFin : SpaceCraftPart
    {
        public override double Width { get { return 2.75; } protected set { value = 2.75; } }
        public override double Height { get { return 8.0; } protected set { value = 8.0; } }
        ...
        {
            return isLeft ? "Textures/Spacecrafts/ITS/SSGridFinLeft.png"
                          : "Textures/Spacecrafts/ITS/SSGridFinRight.png";
        }
